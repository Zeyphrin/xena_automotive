    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col overflow-hidden">
            <header class="h-16 bg-white shadow-sm flex items-center justify-between px-8">
                <h2 class="text-xl font-semibold text-gray-800">Manajemen Pengajuan Peminjaman</h2>
            </header>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-gray-50 text-gray-500 text-sm uppercase tracking-wider border-b border-gray-100">
                                ...
                                <th class="px-6 py-3 font-medium">Durasi Pinjam</th>
                        ...
                        <tbody class="divide-y divide-gray-100 text-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('admin.peminjaman.approval', $rental->id) }}" class="inline-flex items-center px-3 py-1.5 bg-[#0f2a5e] hover:bg-blue-900 text-white text-xs font-medium rounded transition-colors shadow-sm">
                                        Proses / Detail
                                    </a>
                                </td>
                            </tr>
